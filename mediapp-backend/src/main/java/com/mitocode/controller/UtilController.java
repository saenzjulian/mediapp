...
/*
 * Al hacer una petición GET al servicio -> localhost:8080/utils/locale/{en/es/fr}
 * va a recompilar y sobre escribir los beans en la clase MessageConfiguration para así cambiar idioma
 */
