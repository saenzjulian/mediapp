  ...
  canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
    ...
    if (!rpta) {
      ...
      if (!helper.isTokenExpired(token)) {
        ...
        /**
         * Uso pipe porque dentor de un guard no se debería usar un subscribe
         * ya que es un proceso asincrono y puede que el hilo continue su flujo
         * y retorne un valor que no sea el correcto
         */
